...
class FFNComponent(torch.nn.Module):
    ...
    def __init__(self, hidden_size, intermed_size, nonlin_fn=torch.nn.GELU, use_bias=True):
        super().__init__()
        self.dense_in = NMConv(hidden_size, intermed_size, bias=use_bias)
        ...
        self.dense_out = NMConv(intermed_output_size, hidden_size, bias=use_bias)
