...
def main():
    ...
    lr_scheduler = get_scheduler(
        ...
        optimizer=optimizer,
        num_warmup_steps=int(args.max_train_steps * args.num_warmup_steps * accelerator.num_processes) if 0 < args.num_warmup_steps < 1 else args.num_warmup_steps * accelerator.num_processes,
