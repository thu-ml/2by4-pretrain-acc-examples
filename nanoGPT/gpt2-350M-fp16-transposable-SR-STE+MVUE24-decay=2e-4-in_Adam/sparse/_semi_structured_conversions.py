...
def MVUE24_approx(x0, x1, x2, x3,
    ...
    m0 = (random0 <= a0 / sum)
    m1 = ((random0 <= (a0 + a1) / sum) & (random0 > a0 / sum))
    m2 = ((random0 <= (a0 + a1 + a2) / sum) & (random0 > (a0 + a1) / sum))
    m3 = (random0 > (a0 + a1 + a2) / sum)
    ...
    d_m0 = (random1 <= d_a0 / d_sum)
    d_m1 = ((random1 <= (d_a0 + d_a1) / d_sum) & (random1 > d_a0 / d_sum))
    d_m2 = ((random1 <= (d_a0 + d_a1 + d_a2) / d_sum) & (random1 > (d_a0 + d_a1) / d_sum))
    d_m3 = (random1 > (d_a0 + d_a1 + d_a2) / d_sum)

    p0 = (a0 / sum + (a1 / sum) * (a0 / (sum - a1)) + (a2 / sum) * (
            a0 / (sum - a2)) + (a3 / sum) * (a0 / (sum - a3)))
    p1 = (a1 / sum + (a0 / sum) * (a1 / (sum - a0)) + (a2 / sum) * (
            a1 / (sum - a2)) + (a3 / sum) * (a1 / (sum - a3)))
    p2 = (a2 / sum + (a0 / sum) * (a2 / (sum - a0)) + (a1 / sum) * (
            a2 / (sum - a1)) + (a3 / sum) * (a2 / (sum - a3)))
    p3 = (a3 / sum + (a0 / sum) * (a3 / (sum - a0)) + (a1 / sum) * (
            a3 / (sum - a1)) + (a2 / sum) * (a3 / (sum - a2)))

    m0, m1, m2, m3 = m0 | d_m0, m1 | d_m1, m2 | d_m2, m3 | d_m3
    a0 = tl.where(m0, x0 / p0, 0.0)
    a1 = tl.where(m1, x1 / p1, 0.0)
    a2 = tl.where(m2, x2 / p2, 0.0)
    a3 = tl.where(m3, x3 / p3, 0.0)
