...
from model import GPTConfig, GPT, MLP, Block
...
X = torch.rand(batch_size, block_size, n_embd).cuda()
X.requires_grad_(True)
Y = torch.rand(batch_size, block_size, n_embd).cuda()
layer: Block = model.transformer.h[0]
while True:
