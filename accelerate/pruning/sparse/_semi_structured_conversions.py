...
@triton.jit
def _sparse_semi_structured_from_dense_triton(
        dense_ptr,
        sparse_ptr,
        meta_reordered_ptr,
        mask_ptr,
    ...
    if PRUNE == 'mse':
        ...
        dense_40, dense_41, dense_42, dense_43, m0, m1, m2, m3 = MVUE24_approx(dense_40, dense_41, dense_42, dense_43,
                                                                               random0, random1)
        dense_44, dense_45, dense_46, dense_47, m4, m5, m6, m7 = MVUE24_approx(dense_44, dense_45, dense_46, dense_47,
                                                                               random2, random3)
        dense_48, dense_49, dense_4A, dense_4B, m8, m9, mA, mB = MVUE24_approx(dense_48, dense_49, dense_4A, dense_4B,
                                                                               random4, random5)
        dense_4C, dense_4D, dense_4E, dense_4F, mC, mD, mE, mF = MVUE24_approx(dense_4C, dense_4D, dense_4E, dense_4F,
                                                                               random6, random7)
    else:
        m0 = dense_40 != 0
        m1 = dense_41 != 0
...
def sparse_semi_structured_from_dense_triton(dense, sparse, meta, MVUE24: bool = False, mask: Optional[Tensor] = None):
    m, k = dense.shape
    device = dense.device
    ...
    func = _sparse_semi_structured_from_dense_triton
    func[grid](
        dense,
        sparse,
        meta,
